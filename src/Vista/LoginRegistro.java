...
public class LoginRegistro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PanelMain.setBackground(new java.awt.Color(54, 170, 219));
        ...
        jTabbedPane1.setBackground(new java.awt.Color(54, 170, 219));
        jTabbedPane1.setForeground(new java.awt.Color(0, 0, 0));
        jTabbedPane1.setFont(new java.awt.Font("Yu Gothic UI", 1, 18)); // NOI18N
        jTabbedPane1.setOpaque(false);

        PanelIngreso.setBackground(new java.awt.Color(54, 170, 219));
        ...
        txtfieldusuario1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtfieldusuario1ActionPerformed(evt);
            }
        });
        ...
        PanelIngreso.add(Logclose, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, -1, 30));

        Logpass.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/candado.png"))); // NOI18N
        PanelIngreso.add(Logpass, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, -1, -1));

        Loguser.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/usuario.png"))); // NOI18N
        PanelIngreso.add(Loguser, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1, -1));
        ...
        PanelRegistroo.setBackground(new java.awt.Color(54, 170, 219));
        ...
        BtnRegistrar.setBackground(new java.awt.Color(255, 221, 146));
    ...
    private void txtfieldusuario1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtfieldusuario1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtfieldusuario1ActionPerformed

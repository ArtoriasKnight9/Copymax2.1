...
public class Ticket {
    ...
    public void enviarEmailConPDF(String destinatario, String filePath) {
        String host = "smtp.office365.com"; // Servidor SMTP para Hotmail
        final String username = "copymax71@hotmail.com"; // Cambia esto a tu correo de Hotmail
        final String password = "1971berna"; // Cambia esto a tu contraseña

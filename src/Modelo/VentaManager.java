...
public class VentaManager {
    ...
    public int agregarVenta(String usuario, String cliente, String items, double subTotal, double impuesto, double descuento, double total, double recibido, double cambio) {
        Conexion conexion = new Conexion();
        
        String insertSQL = "INSERT INTO venta (Usuario, Cliente, Fecha, Items, Subtotal, Impuesto, Descuento, Total, Recibido, Cambio) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

...
public class Metododepago extends javax.swing.JFrame {
   ...
   public Metododepago(double totalVenta, Ventas ventasPanel) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Efectivo", "Tarjeta", "Vales de Despensa", " " }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Efectivo", "Tarjeta", "Vales de Despensa", " " }));
